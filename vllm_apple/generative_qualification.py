...
_CANDIDATES = (
    ...
    GenerativeCandidate(
        ...
        50,
        True,
        ("sequential-module-residency", "vae-tiling", "mlx-cache-limit-250mb"),
    ),
    GenerativeCandidate(
        ...
        50,
        True,
        ("sequential-module-residency", "vae-tiling", "transformer-block-materialization"),
    ),
    GenerativeCandidate(
        ...
        50,
        True,
        ("sequential-module-residency", "vae-tiling", "attention-query-chunk-512"),
    ),
    GenerativeCandidate(
        ...
        50,
        True,
        ("sequential-module-residency", "vae-tiling", "qkv-mlp-sequence-chunk-512"),
    ),
    GenerativeCandidate(
        "qwen-image-2512",
